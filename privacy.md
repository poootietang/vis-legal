...
**Information you provide as a provider.** When you sign up and use Go-Kart Hippo, you give us:
...
**Information you create about your clients.** As you use Go-Kart Hippo, you enter information about the people you serve:
...
**Information collected automatically.** Go-Kart Hippo uses Sentry (sentry.io), a third-party crash-reporting service, to receive notifications when the app crashes or errors. Sentry receives technical information about the crash (device type, operating system version, the line of code that failed). We have configured Sentry to scrub IP addresses and to not associate crashes with your account email.
...
Go-Kart Hippo does not sell, rent, or trade your information.
...
Go-Kart Hippo is not designed for, marketed to, or intended for use by children under 13. We do not knowingly collect personal information from children under 13. If you believe a child under 13 has provided personal information to Go-Kart Hippo, please contact us at **support@yetzerinvestmentgroup.com** and we will delete that information.
...
- **Opt out** of the "sale" or "sharing" of your personal information — Go-Kart Hippo does not sell or share your personal information, so this right is automatic
...
This policy is governed by the laws of the State of Florida, United States, without regard to conflict-of-law principles. Any dispute arising from your use of Go-Kart Hippo or this policy will be resolved in the state or federal courts located in Florida.
